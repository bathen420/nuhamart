...
class PurchaseReturnService {
 public function __construct(protected PurchaseReturnRepository $repository, protected AccountingService $accounting){}
 public function create(Purchase $purchase,array $data,int $userId): PurchaseReturn{return DB::transaction(function()use($purchase,$data,$userId){
  ...
  $this->accounting->postPurchaseReturn($ret,$userId);
