...
@php
    ...
    $companyAddress = $businessSetting?->address;
    $companyEmail = $businessSetting?->support_email ?: $businessSetting?->email;
    $companyPhone = $businessSetting?->hotline ?: $businessSetting?->phone;
    $currency = $businessSetting?->currency_symbol ?: '৳';
    $logoPath = $businessSetting?->localImagePath('invoice_logo');
...
<div class="page">
            ...
            <tr>
                <td style="width: 58%;">
                    @if($logoPath && file_exists($logoPath))
                        <img src="{{ $logoPath }}" style="max-height:58px;max-width:190px;margin-bottom:6px;">
                    @endif
                    <h1 class="brand-name">{{ $companyName }}</h1>
                    <div class="brand-subtitle">{{ $businessSetting?->company_tagline }}</div>
    ...
    <div class="footer">
        ...
        <div class="thank-you">
            {{ $businessSetting?->invoice_footer ?: 'Thank you for shopping with '.$companyName.'.' }}
        </div>
