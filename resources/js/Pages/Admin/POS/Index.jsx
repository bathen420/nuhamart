                                                ...
                                                {productList.map(
                                                    (product) => (
                                                        <button
                                                            ...
                                                            className="overflow-hidden rounded-xl border border-gray-200 bg-white text-left shadow-sm transition hover:-translate-y-0.5 hover:border-indigo-400 hover:shadow-md"
                                                        >
                                                            <img
                                                                src={productImage(
                                                                    product.image
